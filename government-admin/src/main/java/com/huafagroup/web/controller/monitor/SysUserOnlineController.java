package com.huafagroup.web.controller.monitor;
...
import com.huafagroup.system.domain.SysUserOnline;
import com.huafagroup.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController {
    ...
    public TableDataInfo list(String ipaddr, String userName) {
        Collection<String> keys = redisCache.scanKeys(Constants.LOGIN_TOKEN_KEY + "*");
