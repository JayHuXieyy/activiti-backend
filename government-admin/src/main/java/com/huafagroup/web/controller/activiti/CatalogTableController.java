...
public class CatalogTableController {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "ok", response = CatalogTable.class),
    })
    @RequestMapping(value = "/get", method = RequestMethod.GET)
    public AjaxResult get(String id) {
        CatalogTable item = service.getById(id);
        if (item != null) {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "ok", response = CatalogTableDto.class, responseContainer = "Page"),
    })
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "ok", response = CatalogTable.class,responseContainer = "List"),
    })
    ...
    public AjaxResult update(@RequestBody @Validated CatalogTable item) {
