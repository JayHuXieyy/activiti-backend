...
import com.huafagroup.common.enums.DataSourceType;
import com.huafagroup.common.exception.CustomException;
import com.huafagroup.common.utils.StringUtils;
import com.huafagroup.system.domain.SysConfig;
import com.huafagroup.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements ISysConfigService {
    ...
    public int deleteConfigByIds(Long[] configIds) {
        ...
        if (count > 0) {
            Collection<String> keys = redisCache.scanKeys(Constants.SYS_CONFIG_KEY + "*");
